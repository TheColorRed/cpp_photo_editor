...
//    */
//   shared_ptr<vector<shared_ptr<File>>> files;
...
//     this->files.get()->push_back(file);
//   }
//   /**
//    * Removes the specified file from the files vector.
//    * @param file The file to remove.
//    */
//   void removeFile(shared_ptr<File> file) {
//     this->files.get()->erase(remove(this->files->begin(), this->files->end(), file), this->files->end());
//   }
//   /**
...
//     this->files.get()->erase(this->files->begin() + index);
//   }
//   /**
